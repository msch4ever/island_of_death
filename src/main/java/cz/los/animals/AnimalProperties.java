...
public abstract class AnimalProperties {
    ...
    public AnimalProperties(int weight, int range, double stomachCapacity, double dailyEnergyConsumption,
    ...
    public static Constructor<? extends AnimalProperties> getRootConstructor(Class<? extends AnimalProperties> properties) {
        try {
            return properties.getConstructor(int.class, int.class, double.class, double.class, int.class, int.class, int.class);
