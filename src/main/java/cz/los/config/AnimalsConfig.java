...
public class AnimalsConfig {
    ...
    private static class Keeper {
        ...
        static {
            ...
            try(BufferedReader reader = new BufferedReader(
                ...
                while (reader.ready()) {
                    ...
                    switch (line[0]) {
                        case ("goat") -> animalProperties.put(GOAT, createAnimalProps(AnimalProperties.getRootConstructor(GoatProperties.class), line));
                        case ("wolf") -> animalProperties.put(WOLF, createAnimalProps(AnimalProperties.getRootConstructor(WolfProperties.class), line));
                        //default -> throw new RuntimeException("Unrecognised animal type:" + line[0]);
        ...
        private static AnimalProperties createAnimalProps(Constructor<? extends AnimalProperties> constructor, String[] line) {
            try {
                return constructor
                        .newInstance(Integer.parseInt(line[1]), Integer.parseInt(line[2]), Double.parseDouble(line[3]),
